...
locals {
  ...
  providers = {
    # renovate: datasource=terraform-provider depName=cloudflare
    cloudflare = { version = "~> 5.18.0" }
    # renovate: datasource=terraform-provider depName=external
    external   = { version = "~> 2.3.1" }
    # renovate: datasource=terraform-provider depName=hcloud
    hcloud     = { version = "~> 1.60.1" }
    # renovate: datasource=terraform-provider depName=helm
    helm       = { version = "~> 3.1.1" }
    # renovate: datasource=terraform-provider depName=kubernetes
    kubernetes = { version = "~> 3.0.1" }
    # renovate: datasource=terraform-provider depName=null
    null       = { version = "~> 3.2.4" }
    # renovate: datasource=terraform-provider depName=tailscale
    tailscale  = { version = "~> 0.28.0" }
    # renovate: datasource=terraform-provider depName=talos
