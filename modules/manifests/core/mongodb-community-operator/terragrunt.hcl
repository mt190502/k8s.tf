## ============================================================================================= ##
#  modules/manifests/core/mongodb-community-operator/terragrunt.hcl                               #
#                                                                                                 #
#  Terragrunt wrapper for mongodb community operator module.                                      #
#                                                                                                 #
#  Apply order: longhorn -> [mongodb-community-operator] -> cert-manager                          #
## ============================================================================================= ##
include "common" {
