## ============================================================================================= ##
#  modules/manifests/apps/miniflux/terragrunt.hcl                                                 #
#                                                                                                 #
#  Terragrunt wrapper for miniflux manifests.                                                     #
...
#                                                                                                 #
#  Apply order: (cert-manager/cnpg/psmdb-operator) -> [miniflux]                                  #
## ============================================================================================= ##
include "common" {
...
terraform {
  ...
  after_hook "public_sites_apply" {
    ...
    execute = try(values.enabled, true) ? [
      ...
      "--name", "Miniflux",
      "--domain", "https://${try(values.config.hostname, "miniflux")}.${try(values.config.domain, "example.com")}",
