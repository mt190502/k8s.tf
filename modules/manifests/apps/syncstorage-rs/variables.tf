## ============================================================================================= ##
#  modules/manifests/apps/syncstorage-rs/variables.tf                                             #
#                                                                                                 #
...
#      hostname          --- HTTPRoute hostname subdomain (e.g., "ffsync" -> ffsync.{domain})     #
...
#      replicas          --- Desired replica count (for Deployment)                               #
...
variable "config" {
  ...
  type = object({
    ...
    name              = optional(string, "syncstorage-rs")
